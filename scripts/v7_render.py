...
out=root/'.qa/v7/render_final';out.mkdir(parents=True,exist_ok=True)
...
try:
    ...
    doc=app.Documents.Open(str(root/'reports/完整论文_V7.docx'),ConfirmConversions=False,
    ...
    doc.ExportAsFixedFormat(str(root/'reports/完整论文_V7.pdf'),17)
