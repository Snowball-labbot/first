...
def main():
    source=ROOT/'reports/完整论文_V4.docx';dest=ROOT/'reports/完整论文_V4.pdf'
    qa=ROOT/'.qa/v4/render';qa.mkdir(parents=True,exist_ok=True)
    ...
    (ROOT/'artifacts/v4/render_audit.json').write_text(json.dumps(result,ensure_ascii=False,indent=2),encoding='utf-8')
