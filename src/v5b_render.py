...
def main():
    ...
    qa=ROOT/'.qa/v5b/render';qa.mkdir(parents=True,exist_ok=True)
    ...
    (ROOT/'artifacts/v5b/render_audit.json').write_text(json.dumps(result,ensure_ascii=False,indent=2),encoding='utf-8')
